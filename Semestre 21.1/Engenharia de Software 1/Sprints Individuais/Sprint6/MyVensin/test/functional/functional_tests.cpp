...
class FlowExponencial : public FlowBody{
    public:
        ...
        */
        FlowExponencial(string nome = "", System* origem = NULL, System* destino = NULL): FlowBody(nome, origem, destino){}
...
*/
class FlowLogistico : public FlowBody{
    public:
        /*!
        ...
        */
        FlowLogistico(string nome="", System* origem=NULL, System* destino=NULL): FlowBody(nome, origem, destino){}
        /**
...
class FlowComplexo : public FlowBody{
    public:
        /*!
        ...
        */
        FlowComplexo(string nome = "", System* origem = NULL, System* destino = NULL): FlowBody(nome, origem, destino){}
